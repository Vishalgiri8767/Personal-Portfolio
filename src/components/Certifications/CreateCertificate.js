...
import { Udemy, Coursera,Infosys,GreateLearning,IITBombay, LetUpgrade} from "../asset/svg/svg";
...
const CreateCertificate = (props) => {
    ...
    if (props.item.platform === 'udemy') {
        certImage = <Udemy />;
    }else if (props.item.platform === 'coursera') {
        certImage = <Coursera />;
    }else if (props.item.platform === 'infosys') {
        certImage = <Infosys />;
    }else if (props.item.platform === 'greate learning') {
        certImage = <GreateLearning />;
    }else if (props.item.platform === 'IIT Bombay') {
        certImage = <IITBombay/>;
    }else if (props.item.platform === "let's upgrade") {
        certImage = <LetUpgrade/>;
    }
    return (
