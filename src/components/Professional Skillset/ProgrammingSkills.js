...
import { CPP,Java, Python, MongoDB, FireBase, ReactJS, NodeJs, JavaScript, Redux } from "../asset/svg/svg";
import { useSelector } from "react-redux";
const skills = [Java, Python, FireBase, ReactJS, JavaScript, NodeJs, MongoDB, Redux];
const skillNames=["Java","Python","Firebase","ReactJs","JavaScript","NodeJs","MongoDB","Redux"];
